...
<head>
    ...
    <!-- 2. Your standard Laravel / Vite loading assets come AFTER -->
    <!-- Styles / Scripts -->
    ...
    <!-- 1. CRITICAL: This script runs instantly before the page paints -->
    <!-- Anti-Flash Script: Must be in and run blocking -->
    @include('scripts.anti-flash')
